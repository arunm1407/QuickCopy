package com.example.ocr.screens.screenCapture.service
...
import com.example.ocr.screens.screenCapture.ScreenCaptureActivity
import com.example.ocr.screens.screenCapture.TextSelectionActivity
import java.io.File
...
class ScreenCaptureService : Service() {
    ...
    private fun createNotification(): Notification {
        ...
        val intent = Intent(this, ScreenCaptureActivity::class.java).apply {
            // Add flags to launch the activity on top of other apps without opening your own app
